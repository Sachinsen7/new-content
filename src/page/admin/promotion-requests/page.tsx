...
export default function PromotionRequestsPage() {
  const [submissions, setSubmissions] = useState<Submission[]>(
    mockSubmissions.filter((sub) => sub.type === "promotional-content")
  );
  ...
  const exportToCSV = () => {
    ...
    a.href = url;
    a.download = "promotion-requests.csv";
    a.click();
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-[#88adce]">
                Manage promotional content service requests
              </p>
            </div>
            <Button
              onClick={exportToCSV}
          ...
          <Card className="bg-[#000000] border-[#88adce]/20">
            <CardHeader>
              <CardTitle className="text-[#eceafa]">
                Promotional Content Requests ({filteredSubmissions.length})
              </CardTitle>
              <CardDescription className="text-[#88adce]">
                Complete list of promotional content service requests
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                            ...
                            <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto bg-[#000000] border-[#88adce]/30 text-[#eceafa]">
                              <DialogHeader>
                                ...
                                <DialogDescription className="text-[#88adce]">
                                  Promotional content request from{" "}
                                  {submission.clientName}
                                </DialogDescription>
                              </DialogHeader>
